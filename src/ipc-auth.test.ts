...
describe('IPC message authorization', () => {
  ...
  it('main group can send to any group', () => {
    expect(isMessageAuthorized('main', true, 'tg:other', groups)).toBe(true);
    expect(isMessageAuthorized('main', true, 'tg:third', groups)).toBe(true);
  });
  ...
  it('main group can send to unregistered JID', () => {
    ...
    expect(isMessageAuthorized('main', true, 'tg:unknown', groups)).toBe(true);
  });
});
